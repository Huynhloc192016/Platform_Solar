...
const Layout = () => {
  ...
  return (
    <div className="h-screen overflow-y-auto overflow-x-hidden scrollbar-hidden bg-slate-50 max-w-full">
      <Header onMenuClick={() => setSidebarOpen((v) => !v)} />
      <div className="hidden lg:block fixed inset-x-0 top-[73px] h-[39px] bg-slate-50 z-10" />
      <div className="flex min-w-0">
        ...
        <main className="flex-1 min-w-0 px-4 sm:px-6 lg:px-8 py-8 lg:ml-64">
          <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full min-w-0">
            <div className="hidden lg:block sticky top-[112px] z-20 overflow-x-auto mb-8 -mx-1 px-1 w-full">
